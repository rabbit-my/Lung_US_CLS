...
def setup_logger():
    ...
    log_file = f"pred_radiomics_only_lungUS_wo_aug_wo_labelbalance_cls_seg{timestamp}.log"
    logging.basicConfig(
        level=logging.INFO,
...
def parse_args():
    ...
    parser.add_argument('--data_dir', type=str, 
                       default='/root/data/lungUS_cls/radiomics_features_predicted_seg_labeled',
    ...
    parser.add_argument('--output_dir', type=str, 
                       default='/root/data/lungUS_cls/pred_results_seg/',
